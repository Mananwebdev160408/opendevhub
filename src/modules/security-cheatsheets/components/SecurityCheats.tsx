...
import cheatsheetsData from "../../../../data/security-cheatsheets.json"
...
export function SecurityCheats() {
    ...
    <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 font-mono space-y-8">
      <div className="border-4 border-foreground bg-black p-6 shadow-[6px_6px_0px_0px_rgba(255,255,255,1)] relative overflow-hidden bg-dot-pattern">
        ...
        <h1 className="text-xl sm:text-2xl font-black uppercase text-foreground mb-4 flex items-center gap-2">
          ...
          <span>SECURITY, HEADERS & ENCRYPTION CHEATSHEET</span>
        </h1>
      ...
      <div className="space-y-4">
        <div className="relative border-2 border-foreground bg-zinc-950 p-2 shadow-[3px_3px_0px_0px_var(--primary)] flex items-center gap-2">
          ...
          <input
            type="text"
            placeholder="Search injection, XSS, headers, CSP, HSTS, cryptography, salts, AES..."
            value={searchQuery}
      ...
      <div className="space-y-12">
                ...
                >
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between items-center">
                        <span className="text-[9px] text-zinc-500 font-bold block uppercase">SYNTAX / DIRECTIVES:</span>
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between items-center">
                        <span className="text-[9px] text-zinc-500 font-bold block uppercase">SECURE CODE IMPLEMENTATION:</span>
                  ...
                  {c.mistake && (
                    <div className="border border-red-800 bg-red-950/20 p-3 text-xs text-red-400 leading-relaxed flex gap-2 mt-2">
                      ...
                      <div>
                        <strong>COMMON SECURITY PITFALL:</strong>
        ...
        {filteredData.length === 0 && (
          <div className="border-4 border-dashed border-zinc-800 bg-zinc-950 p-12 text-center space-y-4">
            ...
            <h4 className="text-sm font-black uppercase text-foreground">NO MATCHING SECURITY TOPICS FOUND</h4>
            <p className="text-xs text-muted-foreground max-w-sm mx-auto leading-relaxed">
              We couldn't find anything matching your search term. Try searching for other terms like "CSP", "XSS", "bcrypt", or "AES".
            </p>
            <button
              onClick={() => {
                setSearchQuery("")
