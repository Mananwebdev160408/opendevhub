...
import { FileCode, AlertTriangle, Search, Plus, Trash2, Copy, Download, Layers } from "lucide-react"
import cheatsheetsData from "../../../../data/yaml-cheatsheets.json"
...
export function YamlCheats() {
  ...
  // Calculations for Reference Tab
        ...
        <>
          ...
          <div className="space-y-4">
            <div className="relative border-2 border-foreground bg-zinc-950 p-2 shadow-[3px_3px_0px_0px_var(--primary)] flex items-center gap-2">
              ...
              <input
                type="text"
                placeholder="Search fields, styles, tags, anchors, parameters, or errors (e.g. 'anchor', 'boolean', 'literal', 'folding')..."
                value={searchQuery}
          ...
          <div className="space-y-12">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                          <div className="flex justify-between items-center">
                            <span className="text-[9px] text-zinc-500 font-bold block uppercase">SYNTAX / FORMAT:</span>
                            <CopyButton text={c.syntax} />
                          </div>
                          <pre className="bg-black border border-border p-2 text-xs text-primary block overflow-x-auto select-all whitespace-pre-wrap font-mono">
                            <code>{c.syntax}</code>
                          </pre>
                        </div>
                        ...
                        <div className="space-y-2">
                          <div className="flex justify-between items-center">
                            <span className="text-[9px] text-zinc-500 font-bold block uppercase">EXAMPLE USECASE:</span>
                            <CopyButton text={c.example} />
                          </div>
                          <pre className="bg-black border border-border p-2 text-xs text-accent block overflow-x-auto select-all whitespace-pre-wrap font-mono">
                            <code>{c.example}</code>
                          </pre>
                        </div>
                      </div>
            ...
            {filteredData.length === 0 && (
              <div className="border-4 border-dashed border-zinc-800 bg-zinc-950 p-12 text-center space-y-4">
                ...
                <h4 className="text-sm font-black uppercase text-foreground">NO MATCHING YAML FIELDS OR OPTIONS FOUND</h4>
                <p className="text-xs text-muted-foreground max-w-sm mx-auto leading-relaxed">
                  We couldn't find anything matching your search term. Try searching for other terms like "anchor", "boolean", "chomping" or reset the filters.
                </p>
                <button
                  onClick={() => {
                    setSearchQuery("")
