...
export function ToolboxLayout({ initialTool }: ToolboxLayoutProps) {
  ...
  const tools = [
    ...
    { name: "Word/Char Counter", slug: "character-counter", category: "Text & Parsers", component: <WordCharCounterTool defaultMode="character" /> },
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              {(() => {
                const relatedMapping: Record<string, string[]> = {
                  "json-formatter": ["json-validator", "yaml-viewer", "csv-viewer"],
                  ...
                  "lorem-ipsum": ["character-counter", "slug-generator", "regex-tester"],
                  "slug-generator": ["url-encode", "case-converter", "lorem-ipsum"],
                  "case-converter": ["slug-generator", "character-counter", "regex-tester"],
                  "character-counter": ["lorem-ipsum", "case-converter", "regex-tester"],
                  "cron-parser": ["timestamp-converter", "uuid-generator", "hash-generator"],
                  "diff-checker": ["json-formatter", "case-converter", "regex-tester"],
                  ...
                  "js-minifier": ["css-minifier", "html-minifier", "diff-checker"],
                  "html-minifier": ["css-minifier", "js-minifier", "html-preview"],
                  "json-to-typescript": ["json-formatter", "yaml-json-converter", "diff-checker"],
                  ...
                  "sql-formatter": ["json-formatter", "diff-checker", "case-converter"],
