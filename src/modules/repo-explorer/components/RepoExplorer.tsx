...
const LICENSES = [
  ...
  { label: "Python Software Foundation", value: "psfl" },
  { label: "Boost Software 1.0", value: "bsl-1.0" },
  { label: "NCSA License", value: "ncsa" },
  { label: "Mozilla Public License 2.0", value: "mpl-2.0" },
  { label: "LGPL v2.1", value: "lgpl-2.1" },
  { label: "LGPL v3.0", value: "lgpl-3.0" },
  { label: "Eclipse Public 2.0", value: "epl-2.0" },
  { label: "CDDL 1.0", value: "cddl-1.0" },
  { label: "GPL v2.0", value: "gpl-2.0" },
  { label: "GPL v3.0", value: "gpl-3.0" },
  { label: "AGPL v3.0", value: "agpl-3.0" },
