  ...
  const faqs: FAQItem[] = [
    {
      ...
      answer: "OpenDev Hub is 100% free and open-source. There are no pricing matrices, premium subscription tiers, or locked tools. We sustain the platform's nominal hosting through small, developer-oriented residency sponsorship slots displayed in the footer."
    },
    {
      question: "Where does my data go when I use the developer toolbox?",
      answer: "Nowhere. Your payloads, configuration inputs, secret values, and JWT signatures never leave your terminal. Every utility inside the toolbox is executed strictly inside your browser thread using raw client-side JavaScript. We set no tracking cookies and run zero data telemetry pipelines."
    },
    {
      question: "How does the Repository Explorer query GitHub without a database?",
      answer: "We connect your client browser directly to GitHub's REST API. Queries, search filters, and repository retrievals are executed live. By avoiding middleman API servers, we ensure zero server latency and leverage your browser's caching layers directly."
    },
    {
      question: "How can I contribute a new tool or submit learning resources?",
      answer: "OpenDev Hub is an open project itself. Anyone can clone the repository, suggest modifications to our static JSON datasets under the data folder, or add specialized formatting tools. Simply create a pull request on our GitHub repository to introduce new resources."
    }
  ]
