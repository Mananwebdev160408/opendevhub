...
import { 
  Copy, Check, Sparkles, Terminal, Info, Globe, Mail, 
  Eye, Code, Download, RotateCcw, User, BarChart2, 
  Heart, Plus, Trash2, Shield, Search, BookOpen
} from "lucide-react"
...
export function ReadmeBuilder() {
  // Navigation / Tabs
  const [activeTab, setActiveTab] = React.useState<"intro" | "about" | "skills" | "stats" | "socials" | "support">("intro")
  const [previewMode, setPreviewMode] = React.useState<"preview" | "code">("preview")
  const [previewTheme, setPreviewTheme] = React.useState<"dark" | "light">("dark")

  // State Declarations
  // ── 1. GREETING & INTRO ──
  const [name, setName] = React.useState("Jane Dev")
  const [greetingTitle, setGreetingTitle] = React.useState("Hi there, I'm Jane Dev")
  const [greetingEmoji, setGreetingEmoji] = React.useState("👋")
  const [greetingSubtitle, setGreetingSubtitle] = React.useState("Full Stack Software Engineer")
  
  // Banner
  const [bannerType, setBannerType] = React.useState<"none" | "capsule" | "custom">("capsule")
  const [customBannerUrl, setCustomBannerUrl] = React.useState("")
  const [capsuleType, setCapsuleType] = React.useState<"wave" | "rect" | "waving" | "slice" | "egg">("wave")
  ...
  const [bannerAlign, setBannerAlign] = React.useState<"left" | "center" | "right">("center")
  ...
  const [typingAlign, setTypingAlign] = React.useState<"left" | "center" | "right">("left")
  ...
  const [visitorColor] = React.useState("blue") // Default badge color
  const [visitorStyle, setVisitorStyle] = React.useState<"flat" | "flat-square" | "for-the-badge" | "plastic">("flat-square")
  ...
  const [funFact, setFunFact] = React.useState("I debug by talking to a rubber duck named Jarvis.")

  // ── 3. TECH STACK & BADGES ──
  const [techStyleMode, setTechStyleMode] = React.useState<"badges" | "skillicons">("badges")
  const [badgeStyle, setBadgeStyle] = React.useState<"for-the-badge" | "flat" | "flat-square" | "plastic">("for-the-badge")
  const [techGroupByCat, setTechGroupByCat] = React.useState(false)
  const [skillIconsTheme, setSkillIconsTheme] = React.useState<"dark" | "light">("dark")
  const [selectedTechs, setSelectedTechs] = React.useState<string[]>([
    "TypeScript", "JavaScript", "React", "Next.js", "Node.js", "Docker", "Git"
  ])
  ...
  const techCategories: { category: string; items: TechBadge[] }[] = [
    {
      category: "Languages",
      items: [
        { name: "JavaScript", logo: "javascript", color: "F7DF1E", textColor: "000", skillIconKey: "js" },
        { name: "TypeScript", logo: "typescript", color: "3178C6", skillIconKey: "ts" },
        ...
        { name: "C++", logo: "cplusplus", color: "00599C", skillIconKey: "cpp" },
        { name: "C#", logo: "csharp", color: "239120", skillIconKey: "cs" },
        { name: "Java", logo: "openjdk", color: "ED8B00", skillIconKey: "java" },
        { name: "Ruby", logo: "ruby", color: "CC342D", skillIconKey: "ruby" },
        { name: "PHP", logo: "php", color: "777BB4", skillIconKey: "php" },
        { name: "Swift", logo: "swift", color: "F05138", skillIconKey: "swift" },
        { name: "Kotlin", logo: "kotlin", color: "7F52FF", skillIconKey: "kotlin" },
        ...
        { name: "GraphQL", logo: "graphql", color: "E10098", skillIconKey: "graphql" },
      ]
    },
    {
      category: "Frontend & Styling",
      items: [
        { name: "React", logo: "react", color: "20232A", textColor: "61DAFB", skillIconKey: "react" },
        { name: "Next.js", logo: "nextdotjs", color: "000000", skillIconKey: "nextjs" },
        { name: "Vue", logo: "vuedotjs", color: "4FC08D", skillIconKey: "vue" },
        { name: "Nuxt.js", logo: "nuxtdotjs", color: "00DC82", skillIconKey: "nuxtjs" },
        { name: "Angular", logo: "angular", color: "DD0031", skillIconKey: "angular" },
        { name: "Svelte", logo: "svelte", color: "FF3E00", skillIconKey: "svelte" },
        { name: "SolidJS", logo: "solid", color: "2C4F7C", skillIconKey: "solidity" },
        { name: "TailwindCSS", logo: "tailwindcss", color: "06B6D4", skillIconKey: "tailwind" },
        { name: "Bootstrap", logo: "bootstrap", color: "7952B3", skillIconKey: "bootstrap" },
        { name: "Sass", logo: "sass", color: "CC6699", skillIconKey: "sass" },
        { name: "Figma", logo: "figma", color: "F24E1E", skillIconKey: "figma" },
        { name: "Photoshop", logo: "adobephotoshop", color: "31A8FF", skillIconKey: "ps" }
      ]
    },
    {
      category: "Backend & Database",
      items: [
        { name: "Node.js", logo: "nodedotjs", color: "339933", skillIconKey: "nodejs" },
        { name: "Express", logo: "express", color: "000000", skillIconKey: "express" },
        { name: "NestJS", logo: "nestjs", color: "E0234E", skillIconKey: "nestjs" },
        { name: "Django", logo: "django", color: "092E20", skillIconKey: "django" },
        { name: "FastAPI", logo: "fastapi", color: "009688", skillIconKey: "fastapi" },
        { name: "Flask", logo: "flask", color: "000000", skillIconKey: "flask" },
        { name: "Spring Boot", logo: "springboot", color: "6DB33F", skillIconKey: "spring" },
        { name: "Ruby on Rails", logo: "rubyonrails", color: "CC0000", skillIconKey: "rails" },
        { name: "PostgreSQL", logo: "postgresql", color: "4169E1", skillIconKey: "postgres" },
        { name: "MongoDB", logo: "mongodb", color: "47A248", skillIconKey: "mongodb" },
        { name: "Redis", logo: "redis", color: "DC382D", skillIconKey: "redis" },
        { name: "SQLite", logo: "sqlite", color: "003B57", skillIconKey: "sqlite" },
        { name: "Prisma", logo: "prisma", color: "2D3748", skillIconKey: "prisma" },
        { name: "Supabase", logo: "supabase", color: "3ECF8E", skillIconKey: "supabase" },
        { name: "Firebase", logo: "firebase", color: "FFCA28", textColor: "000", skillIconKey: "firebase" }
      ]
    },
    {
      category: "Mobile & Game Dev",
      items: [
        { name: "Flutter", logo: "flutter", color: "02569B", skillIconKey: "flutter" },
        { name: "React Native", logo: "react", color: "20232A", textColor: "61DAFB", skillIconKey: "react" },
        { name: "SwiftUI", logo: "swift", color: "F05138", skillIconKey: "swift" },
        { name: "Electron", logo: "electron", color: "47848F", skillIconKey: "electron" },
        { name: "Tauri", logo: "tauri", color: "24C8DB", skillIconKey: "tauri" },
        { name: "Unity", logo: "unity", color: "000000", skillIconKey: "unity" },
        { name: "Unreal Engine", logo: "unrealengine", color: "313131", skillIconKey: "unreal" }
      ]
    },
    {
      category: "DevOps & Cloud",
      items: [
        { name: "Docker", logo: "docker", color: "2496ED", skillIconKey: "docker" },
        { name: "Kubernetes", logo: "kubernetes", color: "326CE5", skillIconKey: "kubernetes" },
        { name: "AWS", logo: "amazonwebservices", color: "232F3E", skillIconKey: "aws" },
        { name: "Google Cloud", logo: "googlecloud", color: "4285F4", skillIconKey: "gcp" },
        { name: "Azure", logo: "microsoftazure", color: "0089D6", skillIconKey: "azure" },
        { name: "Vercel", logo: "vercel", color: "000000", skillIconKey: "vercel" },
        { name: "Netlify", logo: "netlify", color: "00C896", skillIconKey: "netlify" },
        { name: "GitHub Actions", logo: "githubactions", color: "2088FF", skillIconKey: "githubactions" },
        { name: "GitLab CI", logo: "gitlab", color: "FCA121", skillIconKey: "gitlab" }
      ]
    },
    {
      ...
      items: [
        ...
        { name: "GitHub", logo: "github", color: "181717", skillIconKey: "github" },
        { name: "VS Code", logo: "visualstudiocode", color: "007ACC", skillIconKey: "vscode" },
        { name: "Postman", logo: "postman", color: "FF6C37", skillIconKey: "postman" },
        { name: "Linux", logo: "linux", color: "FCC624", textColor: "000", skillIconKey: "linux" },
        { name: "Jest", logo: "jest", color: "C21325", skillIconKey: "jest" },
        { name: "Cypress", logo: "cypress", color: "17202C", skillIconKey: "cypress" }
      ]
    }
  ]
  ...
  const [langsLayout, setLangsLayout] = React.useState<"classic" | "compact" | "donut">("compact")
  ...
  const loadTemplate = (type: "minimal" | "full" | "widgets") => {
    if (type === "minimal") {
      ...
      setGithubUser("janedev")
      setWorkingOn("open-source tools and interfaces")
      setLearning("TypeScript interfaces and compiler internals")
      setCollab("")
      setHelp("")
      setAskMe("")
      setPronouns("she/her")
      ...
      setSelectedTechs(["JavaScript", "TypeScript", "HTML5", "CSS3", "React", "Next.js", "TailwindCSS", "Git"])
      ...
      setGreetingEmoji("🚀")
      setGreetingSubtitle("Lead Software Architect | Open-Source Core Maintainer")
      setWorkingOn("next-generation reactive database drivers and orchestration tooling")
      setLearning("WebAssembly systems interfaces and Rust performance profile pipelines")
      ...
      setFunFact("I wrote my first assembler compiler in high school code classes!")
      setTechStyleMode("badges")
      setBadgeStyle("for-the-badge")
      setTechGroupByCat(true)
      setSelectedTechs([
        "TypeScript", "Go", "Rust", "Python", "React", "Next.js", 
        "TailwindCSS", "Node.js", "Express", "PostgreSQL", "Redis", 
        "Docker", "Kubernetes", "AWS", "GitHub Actions", "Git", "VS Code"
      ])
      ...
      setShowTyping(true)
      setTypingLines(["Lead Software Architect", "Rust & Go Enthusiast", "Open-Source Contributor"])
      ...
      setTechStyleMode("skillicons")
      setSkillIconsTheme("dark")
      setSelectedTechs(["JavaScript", "TypeScript", "Python", "React", "Node.js", "Docker", "AWS", "Git", "VS Code"])
  ...
  const resetWorkspace = () => {
    ...
    setCustomMarkdown("")
    setSocialLinks({
      linkedin: "", twitter: "", youtube: "", medium: "", devto: "",
      hashnode: "", stackoverflow: "", discord: "", telegram: "",
      instagram: "", twitch: "", mastodon: "", facebook: "", substack: ""
    })
  }

  // Typings Array Helpers
  const addTypingLine = () => setTypingLines(prev => [...prev, ""])
  const removeTypingLine = (index: number) => setTypingLines(prev => prev.filter((_, i) => i !== index))
  ...
  const generatedMarkdown = React.useMemo(() => {
    ...
    // 6. ABOUT ME
    const hasAbout = workingOn || learning || collab || help || askMe || email || resumeUrl || portfolioUrl || funFact || pronouns || jobStatus || location
    if (hasAbout) {
      md += `### 💫 About Me\n`
      ...
      if (portfolioUrl) md += `- 🌐 Visit my website **[${portfolioUrl}](${portfolioUrl})**\n`
      if (resumeUrl) md += `- 📄 Check out my **[Resume](${resumeUrl})**\n`
      if (pronouns) md += `- 💬 Pronouns: **${pronouns}**\n`
      if (jobStatus) md += `- 💼 Job Status: **${jobStatus}**\n`
      ...
      if (techStyleMode === "badges") {
        if (techGroupByCat) {
          techCategories.forEach(cat => {
            const catTechs = cat.items.filter(item => selectedTechs.includes(item.name))
            if (catTechs.length > 0) {
              ...
              const badgeStrings = catTechs.map(badge => {
                ...
                return `![${badge.name}](https://img.shields.io/badge/${encodeURIComponent(badge.name)}-%23${badge.color}.svg?style=${badgeStyle}&logo=${badge.logo}${textCol})`
              })
              md += badgeStrings.join(" ") + "\n"
            }
          })
          md += "\n"
        } else {
          md += `<p align="left">\n`
          const badgeStrings = selectedTechs.map(tName => {
            let badge: TechBadge | undefined
            for (const cat of techCategories) {
              const found = cat.items.find(item => item.name === tName)
              if (found) { badge = found; break; }
            }
            if (!badge) return ""
            const textCol = badge.textColor ? `&logoColor=${badge.textColor}` : `&logoColor=white`
            return `  ![${badge.name}](https://img.shields.io/badge/${encodeURIComponent(badge.name)}-%23${badge.color}.svg?style=${badgeStyle}&logo=${badge.logo}${textCol})`
        ...
        const mappedKeys = selectedTechs.map(tName => {
          let badge: TechBadge | undefined
          for (const cat of techCategories) {
            const found = cat.items.find(item => item.name === tName)
            if (found) { badge = found; break; }
    ...
    // 8. STATS CARDS
    const hasStatsCards = showStatsCard || showStreakCard || showLangsCard || showGraphCard || showTrophyCard || showLeetcodeCard || showJokesCard
    if (hasStatsCards && githubUser) {
      md += `### 📊 GitHub Dashboard & Metrics\n`
      md += `<p align="left">\n`
      if (showStatsCard) {
        const showIconsVal = statsShowIcons ? "&show_icons=true" : ""
        const privateCommitsVal = statsPrivateCommits ? "&count_private=true" : ""
        const hideRankVal = statsHideRank ? "&hide_rank=true" : ""
        md += `  <a href="https://github.com/${githubUser}">\n    <img src="https://github-readme-stats.vercel.app/api?username=${githubUser}${showIconsVal}${privateCommitsVal}${hideRankVal}&theme=${statsTheme}&locale=en" alt="Stats Card" />\n  </a>\n`
      }
      if (showStreakCard) {
        md += `  <a href="https://github.com/${githubUser}">\n    <img src="https://github-readme-streak-stats.herokuapp.com/?user=${githubUser}&theme=${streakTheme}" alt="Streak Stats" />\n  </a>\n`
      }
      if (showLangsCard) {
        md += `  <a href="https://github.com/${githubUser}">\n    <img src="https://github-readme-stats.vercel.app/api/top-langs/?username=${githubUser}&layout=${langsLayout}&theme=${langsTheme}" alt="Top Languages" />\n  </a>\n`
      }
      if (showGraphCard) {
      ...
      if (showLeetcodeCard && leetcodeUser) {
        md += `  <a href="https://leetcode-stats.vercel.app/api?username=${leetcodeUser}&theme=${leetcodeTheme}" alt="LeetCode Stats" />\n  </a>\n`
      }
      if (showJokesCard) {
        md += `  <img src="https://github-readme-jokes.vercel.app/api?theme=${jokesTheme}" alt="GitHub Readme Jokes" />\n`
      }
      md += `</p>\n\n`
    }

    // 9. CONNECT
    const activeSocials = Object.entries(socialLinks).filter(([_, val]) => !!val)
      ...
      activeSocials.forEach(([key, val]) => {
        ...
        switch (key) {
          ...
          case "discord":
            ...
            linkUrl = val.startsWith("http") ? val : `https://discord.gg/${val}`
            break
          case "telegram":
          ...
          case "mastodon":
            ...
            linkUrl = val.startsWith("http") ? val : `https://mastodon.social/@${val}`
            break
          case "facebook":
        ...
        if (badgeUrl && linkUrl) {
          md += `  <a href="${linkUrl}" target="_blank"><img src="${badgeUrl}" alt="${key}" /></a>\n`
        }
      })
      md += `</p>\n\n`
    }
    ...
    // 10. SUPPORT
    const hasSupport = supportBmc || supportKofi || supportPatreon || supportPaypal
    if (hasSupport) {
      md += `### ☕ Support Me\n`
      md += `<p align="left">\n`
      if (supportBmc) {
        md += `  <a href="https://www.buymeacoffee.com/${supportBmc}" target="_blank"><img src="https://img.shields.io/badge/Buy%20Me%20a%20Coffee-ffdd00?style=${badgeStyle}&logo=buy-me-a-coffee&logoColor=black" alt="Buy Me A Coffee" /></a>\n`
      }
      if (supportKofi) {
        md += `  <a href="https://ko-fi.com/${supportKofi}" target="_blank"><img src="https://img.shields.io/badge/Ko--fi-F16061?style=${badgeStyle}&logo=ko-fi&logoColor=white" alt="Ko-fi" /></a>\n`
      }
      if (supportPatreon) {
        md += `  <a href="https://www.patreon.com/${supportPatreon}" target="_blank"><img src="https://img.shields.io/badge/Patreon-%23F96854.svg?style=${badgeStyle}&logo=patreon&logoColor=white" alt="Patreon" /></a>\n`
      }
      if (supportPaypal) {
        md += `  <a href="https://www.paypal.me/${supportPaypal}" target="_blank"><img src="https://img.shields.io/badge/PayPal-003087?style=${badgeStyle}&logo=paypal&logoColor=white" alt="PayPal" /></a>\n`
      }
      md += `</p>\n\n`
    }
    ...
    if (customMarkdown.trim()) {
      md += `${customMarkdown.trim()}\n\n`
    }

    return md
  }, [
    name, greetingTitle, greetingEmoji, greetingSubtitle, bannerType, customBannerUrl,
    capsuleType, capsuleColor, capsuleCustomHex, capsuleText, capsuleHeight, capsuleFontSize, bannerAlign,
    showTyping, typingLines, typingFont, typingSize, typingColor, typingAlign, typingWidth, typingDuration, typingPause,
    showVisitorCounter, visitorColor, visitorStyle, visitorLabel,
    workingOn, learning, collab, help, askMe, email, portfolioUrl, resumeUrl, pronouns, jobStatus, location, funFact,
    techStyleMode, badgeStyle, techGroupByCat, skillIconsTheme, selectedTechs,
    githubUser, showStatsCard, statsTheme, statsShowIcons, statsPrivateCommits, statsHideRank,
    showStreakCard, streakTheme, showLangsCard, langsLayout, langsTheme,
    showGraphCard, graphTheme, showTrophyCard, trophyTheme, trophyColumns,
    showLeetcodeCard, leetcodeUser, leetcodeTheme, showJokesCard, jokesTheme,
    socialLinks, supportBmc, supportKofi, supportPatreon, supportPaypal, customMarkdown
  ])
  ...
  const handleDownload = () => {
    const blob = new Blob([generatedMarkdown], { type: "text/plain;charset=utf-8" })
  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 font-mono space-y-8">
      ...
      {/* ── HEADER PANEL ── */}
      <div className="border-4 border-foreground bg-black p-6 shadow-[6px_6px_0px_0px_var(--primary)] relative overflow-hidden bg-dot-pattern">
        <div className="absolute top-2 right-4 text-[9px] text-zinc-500 font-bold uppercase select-none">
          v2.0 // Neo Architect
        </div>
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <h1 className="text-xl sm:text-3xl font-black uppercase text-foreground mb-2 flex items-center gap-2">
              <Terminal className="h-6 w-6 text-accent animate-pulse" />
              <span>NEO README ARCHITECT</span>
            </h1>
            <p className="text-xs text-muted-foreground leading-relaxed max-w-xl">
              Design a gorgeous developer landing page for your GitHub profile. Customize banners, typing effects, visitor badges, skills flow, and real-time telemetry.
            </p>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        {/* ── LEFT EDITOR WORKSPACE - 5 Columns ── */}
        <div className="lg:col-span-5 border-4 border-foreground bg-card shadow-[4px_4px_0px_0px_var(--primary)] flex flex-col md:flex-row h-[750px] overflow-hidden">
          
          {/* Tab Sidebar Navigation */}
          <div className="bg-black md:w-[150px] w-full border-b md:border-b-0 md:border-r border-foreground flex md:flex-col overflow-x-auto md:overflow-x-visible select-none shrink-0">
            {[
              { id: "intro", label: "Intro & Header", icon: Sparkles },
              { id: "about", label: "About Me", icon: User },
              { id: "skills", label: "Tech Stack", icon: Terminal },
              { id: "stats", label: "Stats Cards", icon: BarChart2 },
              { id: "socials", label: "Social Connect", icon: Globe },
              { id: "support", label: "Support & Coffee", icon: Heart },
            ].map(tab => {
              const Icon = tab.icon
              ...
              return (
                <button
                  ...
                  className={`w-full py-4 px-3 text-left font-black uppercase text-[10px] tracking-wider border-b border-zinc-900 transition-all flex md:flex-col gap-2 items-center justify-center md:justify-start cursor-pointer ${
                    isActive 
                      ? "bg-accent text-accent-foreground border-r-0" 
          ...
          {/* Tab Content Panel */}
          <div className="flex-grow p-5 overflow-y-auto h-full space-y-5 text-xs">
            
            {/* 🚀 TAB 1: INTRO & HEADER */}
            {activeTab === "intro" && (
              <div className="space-y-5">
                <div>
                  <h3 className="font-bold text-accent text-sm uppercase mb-2">Banners & Headers</h3>
                  <div className="space-y-3">
                    <div>
                      <label className="block text-[9px] text-zinc-500 uppercase font-bold mb-1">Banner Type</label>
                      <select 
                        value={bannerType}
                      ...
                      >
                        ...
                        <option value="capsule">Capsule Render (Dynamic SVG)</option>
                    ...
                    {bannerType === "capsule" && (
                      <div className="border border-zinc-800 p-3 bg-zinc-950 space-y-3">
                        <div className="grid grid-cols-2 gap-2">
                          <div>
                            <label className="block text-[9px] text-zinc-500 uppercase">Capsule Style</label>
                            <select 
                              value={capsuleType}
                          ...
                          <div>
                            <label className="block text-[9px] text-zinc-500 uppercase">Theme / Color</label>
                            <select 
                              value={capsuleColor}
                        ...
                        {capsuleColor === "custom" && (
                          <div>
                            <label className="block text-[9px] text-zinc-500 uppercase">Custom Color Hex</label>
                            <div className="flex gap-2 items-center">
                              <input 
                                type="color" 
                                value={capsuleCustomHex}
                                onChange={(e) => setCapsuleCustomHex(e.target.value)}
                        ...
                        <div>
                          <label className="block text-[9px] text-zinc-500 uppercase">Banner text</label>
                          <input 
                            type="text" 
                            value={capsuleText}
                        ...
                        <div className="grid grid-cols-2 gap-2">
                          <div>
                            <label className="block text-[9px] text-zinc-500 uppercase">Height ({capsuleHeight}px)</label>
                            <input 
                              type="range" 
                              min="80" 
                              max="300"
                              value={capsuleHeight}
                              onChange={(e) => setCapsuleHeight(Number(e.target.value))}
                              className="w-full accent-accent"
                            />
                          </div>
                          <div>
                            <label className="block text-[9px] text-zinc-500 uppercase">Font Size ({capsuleFontSize}px)</label>
                            <input 
                              type="range" 
                              min="20" 
                              max="80"
                              value={capsuleFontSize}
                              onChange={(e) => setCapsuleFontSize(Number(e.target.value))}
                              className="w-full accent-accent"
                            />
                          </div>
                        </div>
                    ...
                    {bannerType === "custom" && (
                      <div className="border border-zinc-800 p-3 bg-zinc-950">
                        <label className="block text-[9px] text-zinc-500 uppercase mb-1">Banner Image URL</label>
                        <input 
                          type="text" 
                    ...
                    {bannerType !== "none" && (
                      <div>
                        <label className="block text-[9px] text-zinc-500 uppercase font-bold mb-1">Banner Alignment</label>
                          ...
                          {["left", "center", "right"].map(align => (
                            <button
                              ...
                              className={`py-1 border text-[9px] uppercase font-bold cursor-pointer ${
                                bannerAlign === align ? "bg-accent text-accent-foreground border-foreground" : "bg-black border-zinc-850 hover:border-foreground"
                              }`}
                            >
                              {align}
                            </button>
                ...
                {/* Greetings */}
                <div>
                  <h3 className="font-bold text-accent text-sm uppercase mb-2">Greeting Title</h3>
                  <div className="space-y-3">
                    <div className="grid grid-cols-4 gap-2">
                      <div className="col-span-3">
                        <label className="block text-[9px] text-zinc-500 uppercase">Title Header</label>
                        <input 
                          type="text" 
                          value={greetingTitle}
                      ...
                      <div>
                        <label className="block text-[9px] text-zinc-500 uppercase">Emoji</label>
                        <input 
                          type="text" 
                          value={greetingEmoji}
                    ...
                    <div>
                      <label className="block text-[9px] text-zinc-500 uppercase">Subtitle Description</label>
                      <input 
                        type="text" 
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <h3 className="font-bold text-accent text-sm uppercase">Animated Typing text</h3>
                    <input 
                      type="checkbox" 
                      checked={showTyping}
                  ...
                  {showTyping && (
                    <div className="border border-zinc-800 p-3 bg-zinc-950 space-y-3">
                      <div className="space-y-2">
                        <label className="block text-[9px] text-zinc-500 uppercase font-bold">Text lines</label>
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        <div>
                          <label className="block text-[9px] text-zinc-500 uppercase">Font Family</label>
                          <select 
                            value={typingFont}
                        ...
                        <div>
                          <label className="block text-[9px] text-zinc-500 uppercase">Text color (Hex)</label>
                      ...
                      <div className="grid grid-cols-3 gap-2">
                        <div>
                          <label className="block text-[9px] text-zinc-500 uppercase">Size ({typingSize}px)</label>
                          <input 
                            type="number" 
                            value={typingSize} 
                            onChange={(e) => setTypingSize(Number(e.target.value))}
                            className="w-full border border-foreground bg-black px-1 py-0.5"
                          />
                        </div>
                        <div>
                          <label className="block text-[9px] text-zinc-500 uppercase">Align</label>
                          <select 
                            value={typingAlign} 
                            onChange={(e) => setTypingAlign(e.target.value as any)}
                        ...
                        <div>
                          <label className="block text-[9px] text-zinc-500 uppercase">Width ({typingWidth}px)</label>
                          <input 
                            type="number" 
                            value={typingWidth} 
                            onChange={(e) => setTypingWidth(Number(e.target.value))}
                            className="w-full border border-foreground bg-black px-1 py-0.5"
                          />
                        </div>
                      </div>
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <h3 className="font-bold text-accent text-sm uppercase">Visitor Counter</h3>
                    <input 
                      type="checkbox" 
                  ...
                  {showVisitorCounter && (
                    <div className="border border-zinc-800 p-3 bg-zinc-950 space-y-3">
                      <div>
                        <label className="block text-[9px] text-zinc-500 uppercase">Visitor Label</label>
                        <input 
                          type="text" 
                          value={visitorLabel}
                      ...
                      <div>
                        <label className="block text-[9px] text-zinc-500 uppercase">Visitor Badge Style</label>
                        <select 
                          value={visitorStyle}
                          onChange={(e) => setVisitorStyle(e.target.value as any)}
            ...
            {activeTab === "about" && (
              <div className="space-y-4">
                <h3 className="font-bold text-accent text-sm uppercase">Profile & Bio Bullet Points</h3>
                <p className="text-[10px] text-zinc-500 leading-relaxed uppercase">
                  Fill in standard details. Fields left blank will be skipped in markdown.
                </p>

                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <label className="block text-[9px] text-zinc-500 uppercase">Pronouns</label>
                    <input 
                      type="text" 
                      value={pronouns} 
                  ...
                  <div>
                    <label className="block text-[9px] text-zinc-500 uppercase">Job Status</label>
                    <input 
                      type="text" 
                      value={jobStatus} 
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <label className="block text-[9px] text-zinc-500 uppercase">Location</label>
                    <input 
                      type="text" 
                      value={location} 
                  ...
                  <div>
                    <label className="block text-[9px] text-zinc-500 uppercase">Contact Email</label>
                    <input 
                      type="text" 
                      value={email} 
                ...
                <div>
                  <label className="block text-[9px] text-zinc-500 uppercase">I'm currently working on</label>
                  <input 
                    type="text" 
                    value={workingOn} 
                ...
                <div>
                  <label className="block text-[9px] text-zinc-500 uppercase">I'm currently learning</label>
                  <input 
                    type="text" 
                    value={learning} 
                ...
                <div>
                  <label className="block text-[9px] text-zinc-500 uppercase">I'm looking to collaborate on</label>
                  <input 
                    type="text" 
                    value={collab} 
                ...
                <div>
                  <label className="block text-[9px] text-zinc-500 uppercase">I'm looking for help with</label>
                  <input 
                    type="text" 
                    value={help} 
                ...
                <div>
                  <label className="block text-[9px] text-zinc-500 uppercase">Ask me about</label>
                  <input 
                    type="text" 
                    value={askMe} 
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <label className="block text-[9px] text-zinc-500 uppercase">Portfolio Website URL</label>
                    <input 
                      type="text" 
                      value={portfolioUrl} 
                  ...
                  <div>
                    <label className="block text-[9px] text-zinc-500 uppercase">Resume URL</label>
                    <input 
                      type="text" 
                      value={resumeUrl} 
                ...
                <div>
                  <label className="block text-[9px] text-zinc-500 uppercase">Fun Fact</label>
                  <textarea 
                    value={funFact} 
            ...
            {activeTab === "skills" && (
              <div className="space-y-4">
                <h3 className="font-bold text-accent text-sm uppercase">Tech Stack & Tools</h3>
                
                {/* Visual Settings */}
                <div className="border border-zinc-800 p-3 bg-zinc-950 space-y-3">
                  <div>
                    <label className="block text-[9px] text-zinc-500 uppercase font-bold">Display Style</label>
                    <div className="grid grid-cols-2 gap-2 mt-1">
                      <button
                        onClick={() => setTechStyleMode("badges")}
                        className={`py-1.5 border text-[9px] uppercase font-bold cursor-pointer ${
                          techStyleMode === "badges" ? "bg-accent text-accent-foreground border-foreground" : "bg-black border-zinc-850 hover:border-foreground"
                        }`}
                      >
                        Shields.io Badges
                      </button>
                      <button
                        ...
                        className={`py-1.5 border text-[9px] uppercase font-bold cursor-pointer ${
                          techStyleMode === "skillicons" ? "bg-accent text-accent-foreground border-foreground" : "bg-black border-zinc-850 hover:border-foreground"
                        }`}
                      >
                        Skill Icons
                      </button>
                  ...
                  {techStyleMode === "badges" && (
                    <>
                      <div>
                        <label className="block text-[9px] text-zinc-500 uppercase">Badge Styling</label>
                        <select 
                          value={badgeStyle}
                  ...
                  {techStyleMode === "skillicons" && (
                    <div>
                      <label className="block text-[9px] text-zinc-500 uppercase">Skill Icons Theme</label>
                      <select 
                        value={skillIconsTheme}
                        onChange={(e) => setSkillIconsTheme(e.target.value as any)}
                        className="w-full border border-foreground bg-black px-1.5 py-1 text-[10px] text-foreground cursor-pointer"
                      >
                ...
                <div className="space-y-3">
                  <div className="flex gap-2 items-center border border-zinc-800 bg-zinc-950 px-2 py-1">
                    ...
                    />
                    {skillsSearch && (
                      <button onClick={() => setSkillsSearch("")} className="text-zinc-500 hover:text-foreground">×</button>
                    )}
                  </div>
                  ...
                  <div className="flex gap-2 justify-end text-[9px] uppercase font-bold">
                    <button 
                      onClick={() => {
                        const allNames = techCategories.flatMap(c => c.items.map(i => i.name))
                  ...
                  <div className="space-y-3 max-h-[350px] overflow-y-auto pr-1">
                    {getFilteredCategories().map((cat, idx) => (
                      <div key={idx} className="space-y-1.5 border border-zinc-900 p-2 bg-zinc-950">
                        <span className="text-[9px] text-zinc-500 font-bold block uppercase border-b border-zinc-900 pb-0.5">{cat.category}</span>
                              ...
                              <button
                                ...
                                className={`px-2 py-1 border text-[9px] font-black uppercase cursor-pointer transition-all ${
                                  isSelected
                                    ...
                                    : "border-zinc-855 text-zinc-500 hover:border-zinc-700 bg-black"
                                }`}
                              >
                                {item.name}
                              </button>
            ...
            {activeTab === "stats" && (
              <div className="space-y-4">
                <h3 className="font-bold text-accent text-sm uppercase">GitHub Telemetry Cards</h3>
                
                <div>
                  <label className="block text-[9px] text-zinc-500 uppercase font-bold">GitHub Username</label>
                  <input 
                    type="text" 
                    value={githubUser} 
                ...
                <p className="text-[9px] text-zinc-500 uppercase leading-relaxed">
                  Toggle dashboard widgets below. Customize themes dynamically.
                </p>
                ...
                <div className="space-y-3">
                  ...
                  <div className="border border-zinc-900 bg-zinc-950 p-2.5 space-y-2">
                    ...
                    {showStatsCard && (
                      <div className="grid grid-cols-2 gap-2 text-[9px] mt-2 border-t border-zinc-900 pt-2">
                        <div>
                          <label className="block text-zinc-500 uppercase">Theme</label>
                          <select 
                            value={statsTheme} 
                        ...
                        <div className="space-y-1 self-end">
                          <label className="flex items-center gap-1 cursor-pointer">
                            <input 
                              ...
                              onChange={(e) => setStatsShowIcons(e.target.checked)}
                              className="accent-primary"
                            />
                            <span>Icons</span>
                          </label>
                          <label className="flex items-center gap-1 cursor-pointer">
                            <input 
                              ...
                              onChange={(e) => setStatsPrivateCommits(e.target.checked)}
                              className="accent-primary"
                            />
                  ...
                  <div className="border border-zinc-900 bg-zinc-950 p-2.5 space-y-2">
                    ...
                    {showLangsCard && (
                      <div className="grid grid-cols-2 gap-2 text-[9px] mt-2 border-t border-zinc-900 pt-2">
                        <div>
                          <label className="block text-zinc-500 uppercase">Layout</label>
                          <select 
                            value={langsLayout} 
                            onChange={(e) => setLangsLayout(e.target.value as any)}
                            className="w-full border border-foreground bg-black px-1 py-0.5 cursor-pointer"
                          >
                  ...
                  <div className="border border-zinc-900 bg-zinc-950 p-2.5 space-y-2">
                    ...
                    {showTrophyCard && (
                      <div className="grid grid-cols-2 gap-2 text-[9px] mt-2 border-t border-zinc-900 pt-2">
                        <div>
                          <label className="block text-[#ccc] uppercase">Theme</label>
                          <select 
                            value={trophyTheme} 
                        ...
                        <div>
                          <label className="block text-[#ccc] uppercase font-bold">Cols ({trophyColumns})</label>
                          <input 
                            type="number" 
                            min="2" 
                            max="8" 
                            value={trophyColumns} 
                            onChange={(e) => setTrophyColumns(Number(e.target.value))}
                            className="w-full border border-foreground bg-black px-1 py-0.5"
                          />
                        </div>
                      </div>
                  ...
                  <div className="border border-zinc-900 bg-zinc-950 p-2.5 space-y-2">
                    <div className="flex items-center justify-between">
                      <label className="flex items-center gap-1.5 cursor-pointer font-bold uppercase text-[10px]">
                        <input 
                          ...
                          onChange={(e) => setShowLeetcodeCard(e.target.checked)}
                          className="accent-primary"
                        />
                    ...
                    {showLeetcodeCard && (
                      <div className="grid grid-cols-2 gap-2 text-[9px] mt-2 border-t border-zinc-900 pt-2">
                        <div>
                          <label className="block text-zinc-500 uppercase font-bold">LeetCode User</label>
                          <input 
                            type="text" 
                            value={leetcodeUser} 
            ...
            {activeTab === "socials" && (
              <div className="space-y-4">
                <h3 className="font-bold text-accent text-sm uppercase">Social Connections</h3>
                <p className="text-[10px] text-zinc-500 uppercase">
                  Input usernames or handle keys. Branded badges are generated.
                </p>
                ...
                <div className="grid grid-cols-2 gap-3 max-h-[450px] overflow-y-auto pr-1">
                  {[
                    ...
                    <div key={social.key} className="space-y-1">
                      <label className="block text-[9px] text-zinc-500 uppercase font-bold">{social.label}</label>
                      <input 
                        type="text" 
            ...
            {activeTab === "support" && (
              <div className="space-y-4">
                <h3 className="font-bold text-accent text-sm uppercase">Support & Custom sections</h3>
                
                <div className="space-y-3">
                  <div>
                    <label className="block text-[9px] text-zinc-500 uppercase">Buy Me a Coffee ID</label>
                    <input 
                      type="text" 
                      value={supportBmc} 
                  ...
                  <div>
                    <label className="block text-[9px] text-zinc-500 uppercase">Ko-fi ID</label>
                    <input 
                      type="text" 
                      value={supportKofi} 
                  ...
                  <div>
                    <label className="block text-[9px] text-zinc-500 uppercase">Patreon Username</label>
                    <input 
                      type="text" 
                  ...
                  <div>
                    <label className="block text-[9px] text-zinc-500 uppercase">PayPal.me Handle</label>
                    <input 
                      type="text" 
                      value={supportPaypal} 
                ...
                <div>
                  <label className="block text-[10px] text-accent font-bold uppercase mb-1">Custom Extra Markdown</label>
                  <p className="text-[9px] text-zinc-500 uppercase mb-2">Write any extra markdown text, links or widgets here.</p>
                  <textarea 
                    value={customMarkdown} 
                    onChange={(e) => setCustomMarkdown(e.target.value)}
                    className="w-full border border-foreground bg-black px-2 py-1.5 h-32 text-foreground font-mono text-[10px]"
        ...
        <div className="lg:col-span-7 space-y-4">
          ...
          <div className="border-4 border-foreground bg-[#0a0a0c] shadow-[4px_4px_0px_0px_#ffffff] flex flex-col h-[750px]">
                ...
                {previewMode === "preview" && (
                  <div className="flex border border-zinc-800 bg-black text-[9px] uppercase font-bold overflow-hidden">
                    ...
                    <button 
                      ...
                      className={`px-2 py-0.5 ${previewTheme === "light" ? "bg-zinc-200 text-black border-l border-zinc-800" : "text-zinc-500 hover:text-foreground cursor-pointer border-l border-zinc-800"}`}
                    >
                      GH Light
                    </button>
                  </div>
            ...
            <div className="flex-grow overflow-auto p-4 bg-zinc-950">
              ...
              {previewMode === "preview" ? (
                /* HTML rendered preview, resembling a real GitHub repo dashboard box */
                <div className="border border-zinc-800 rounded overflow-hidden max-w-3xl mx-auto shadow-lg bg-black">
                  
                  {/* Mock Repository File Header */}
                  <div className="bg-zinc-900/50 border-b border-zinc-800 px-4 py-3 flex items-center justify-between select-none">
                  ...
                  >
                    <div 
                      className={`readme-preview-content ${
                        previewTheme === "dark" 
                          ? "prose-dark [&_h1]:text-2xl [&_h1]:font-semibold [&_h1]:border-b [&_h1]:border-[#21262d] [&_h1]:pb-2 [&_h1]:mt-6 [&_h1]:mb-4 [&_h1]:text-[#f0f6fc] [&_h2]:text-xl [&_h2]:font-semibold [&_h2]:border-b [&_h2]:border-[#21262d] [&_h2]:pb-1 [&_h2]:mt-5 [&_h2]:mb-3 [&_h2]:text-[#f0f6fc] [&_h3]:text-lg [&_h3]:font-semibold [&_h3]:mt-4 [&_h3]:mb-2 [&_h3]:text-[#f0f6fc] [&_ul]:list-disc [&_ul]:pl-6 [&_ul]:my-3 [&_li]:my-1 [&_p]:my-3 [&_p]:leading-relaxed [&_a]:text-[#58a6ff] [&_a]:hover:underline [&_img]:inline-block [&_img]:my-1 [&_hr]:border-[#21262d] [&_hr]:my-6 [&_pre]:bg-[#161b22] [&_pre]:p-4 [&_pre]:rounded [&_pre]:overflow-x-auto [&_code]:font-mono [&_code]:text-xs [&_code]:bg-[#161b22] [&_code]:px-1 [&_code]:py-0.5 [&_code]:rounded [&_pre_code]:bg-transparent [&_pre_code]:p-0"
                          : "prose-light [&_h1]:text-2xl [&_h1]:font-semibold [&_h1]:border-b [&_h1]:border-[#d0d7de] [&_h1]:pb-2 [&_h1]:mt-6 [&_h1]:mb-4 [&_h1]:text-[#24292f] [&_h2]:text-xl [&_h2]:font-semibold [&_h2]:border-b [&_h2]:border-[#d0d7de] [&_h2]:pb-1 [&_h2]:mt-5 [&_h2]:mb-3 [&_h2]:text-[#24292f] [&_h3]:text-lg [&_h3]:font-semibold [&_h3]:mt-4 [&_h3]:mb-2 [&_h3]:text-[#24292f] [&_ul]:list-disc [&_ul]:pl-6 [&_ul]:my-3 [&_li]:my-1 [&_p]:my-3 [&_p]:leading-relaxed [&_a]:text-[#0969da] [&_a]:hover:underline [&_img]:inline-block [&_img]:my-1 [&_hr]:border-[#d0d7de] [&_hr]:my-6 [&_pre]:bg-[#f6f8fa] [&_pre]:p-4 [&_pre]:rounded [&_pre]:overflow-x-auto [&_code]:font-mono [&_code]:text-xs [&_code]:bg-[#afb8c133] [&_code]:px-1 [&_code]:py-0.5 [&_code]:rounded [&_pre_code]:bg-transparent [&_pre_code]:p-0"
                      }`}
                      dangerouslySetInnerHTML={{ __html: renderedHtml || "<p class='text-zinc-500 italic'>No content generated yet.</p>" }} 
                    />
                  </div>
            ...
            <div className="border-t border-foreground bg-black p-3 text-[10px] text-zinc-500 select-none flex items-center gap-2">
              ...
              <span>Copy and paste this compiled markdown directly into your GitHub account's repository (username/username) README.md file.</span>
            </div>
